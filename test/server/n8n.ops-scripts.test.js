...
function writeFakeDocker(tempRoot) {
  ...
  fs.writeFileSync(
    ...
    [
      ...
      '  "exec n8n-runners cat /etc/n8n-task-runners.json") printf "{\\"task-runners\\":[{\\"runner-type\\":\\"javascript\\",\\"health-check-server-port\\":\\"5681\\",\\"env-overrides\\":{\\"NODE_FUNCTION_ALLOW_BUILTIN\\":\\"crypto,node:path,node:process\\",\\"NODE_FUNCTION_ALLOW_EXTERNAL\\":\\"@igasovic/n8n-blocks,igasovic-n8n-blocks\\"}},{\\"runner-type\\":\\"python\\",\\"health-check-server-port\\":\\"5682\\",\\"env-overrides\\":{\\"PYTHONPATH\\":\\"/opt/runners/task-runner-python\\"}}]}" ;;',
