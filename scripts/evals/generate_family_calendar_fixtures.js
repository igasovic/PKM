...
const normalizeClean = withIds([
  ...
  { name: 'school meeting kid category', bucket: 'clean', failure_tags: ['field_extraction'], input: { raw_text: 'Iva school meeting tuesday at 14:00 for 45 min' }, expect: { status: 'ready_to_create', category_code: 'SCH', duration_minutes: 60, subject_people_tag: 'Iv' } },
  ...
  { name: 'school parent meeting with two people', bucket: 'clean', failure_tags: ['field_extraction'], input: { raw_text: 'school parent meeting wednesday at 18:00 with Iva Danijela' }, expect: { status: 'ready_to_create', category_code: 'SCH', duration_minutes: 60, subject_people_tag: 'Iv,D' } },
  ...
  { name: 'family people do not force category', bucket: 'clean', failure_tags: ['field_extraction'], input: { raw_text: 'Mila Danijela Igor Louie appointment tomorrow at 3:00p for 90 min' }, expect: { status: 'ready_to_create', category_code: 'MED', duration_minutes: 90, padded: true, subject_people_tag: 'FAM', logical_color: 'green' } },
