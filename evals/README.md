# Family Calendar Evals (Non-Gating)

This directory contains non-gating live eval fixtures and reports for family-calendar routing and normalization.
...
```bash
./scripts/evals/run_evals.sh --router --calendar --backend-url http://pkm-server:8080 --admin-secret "$PKM_ADMIN_SECRET"
```
