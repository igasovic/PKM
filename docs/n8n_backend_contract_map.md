...
|---|---|---|---|
| `10 Read` (Telegram PKM command surface) | `POST /db/read/pull`, `POST /db/read/last`, `POST /db/read/continue`, `POST /db/read/find`, `POST /recipes/get`, `POST /recipes/search`, `POST /recipes/create`, `POST /recipes/link`, `POST /recipes/note`, `POST /pkm/classify/batch`, `POST /distill/sync`, `POST /distill/run`, `GET /status/batch`, `/waiting -> 36 Todoist Waiting Radar` | `docs/api_read_write.md`, `docs/api_recipes.md`, `docs/api_ingest.md`, `docs/api_distill.md`, `docs/api_todoist.md`, `docs/PRD/read-prd.md`, `docs/PRD/recipes-prd.md`, `docs/PRD/todoist-llm-planning-prd.md` | `test/server/read-write.api-contract.test.js`, `test/server/recipes.api-contract.test.js`, `test/server/classify.api-contract.test.js`, `test/server/tier2.api-contract.test.js`, `test/server/n8n.command-parser.test.js`, `test/server/n8n.todoist-workflows.test.js` |
| `05 ChatGPT Wrap Commit` | `POST /chatgpt/wrap-commit` | `docs/api_control.md`, `docs/PRD/active_topics_and_working_memory_prd.md`, `docs/PRD/gpt-actions-integration-prd.md` | `test/server/chatgpt.api-contract.test.js` |
| `11 ChatGPT Read Router` | `POST /db/read/pull`, `POST /db/read/last`, `POST /db/read/continue`, `POST /db/read/find`, `POST /chatgpt/working_memory` | `docs/api_read_write.md`, `docs/api_control.md`, `docs/PRD/read-prd.md`, `docs/PRD/active_topics_and_working_memory_prd.md` | `test/server/read-write.api-contract.test.js`, `test/server/chatgpt.api-contract.test.js`, `test/server/n8n.wf11-route-read-request.test.js` |
| Telegram and capture ingest flows | `POST /normalize/telegram`, `POST /ingest/telegram/url-batch`, `POST /normalize/email/intent`, `POST /normalize/email`, `POST /normalize/webpage`, `POST /normalize/notion`, `POST /pkm/insert`, `POST /pkm/insert/batch`, `POST /pkm/classify`, `POST /enrich/t1/batch` | `docs/api_ingest.md`, `docs/api_read_write.md` | `test/server/classify.api-contract.test.js`, `test/server/read-write.api-contract.test.js`, `test/server/telegram-url-batch-ingest.test.js` |
...
| Todoist sync scheduler | `POST /todoist/sync` | `docs/api_todoist.md`, `docs/PRD/todoist-llm-planning-prd.md` | `test/server/todoist.api-contract.test.js`, `test/server/n8n.todoist-workflows.test.js` |
| Todoist daily focus | `POST /todoist/sync`, `POST /todoist/brief/daily` | `docs/api_todoist.md`, `docs/PRD/todoist-llm-planning-prd.md` | `test/server/todoist.api-contract.test.js`, `test/server/n8n.todoist-workflows.test.js` |
| Todoist waiting radar | `POST /todoist/sync`, `POST /todoist/brief/waiting` | `docs/api_todoist.md`, `docs/PRD/todoist-llm-planning-prd.md` | `test/server/todoist.api-contract.test.js`, `test/server/n8n.todoist-workflows.test.js` |
| Todoist weekly pruning | `POST /todoist/sync`, `POST /todoist/brief/weekly` | `docs/api_todoist.md`, `docs/PRD/todoist-llm-planning-prd.md` | `test/server/todoist.api-contract.test.js`, `test/server/n8n.todoist-workflows.test.js` |
...
| WF99 failure/debug flows | `POST /debug/failures`, `GET /debug/failures`, `GET /debug/failures/open`, `GET /debug/failures/:failure_id`, `POST /debug/failures/:failure_id/analyze`, `POST /debug/failures/:failure_id/resolve`, `GET /debug/failures/by-run/:run_id`, `GET /debug/failure-bundle/:run_id`, `GET /debug/runs`, `GET /debug/run/:run_id`, `GET /debug/run/last` | `docs/api_control.md`, `docs/PRD/failure-pack-prd.md` | `test/server/failure-pack.api-contract.test.js`, `test/server/control.api-contract.test.js` |
